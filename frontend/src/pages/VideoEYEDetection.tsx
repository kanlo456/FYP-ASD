...
const VideoEYEDetectionPage: React.FC = () => {
  ...
  async function handleImageSubmit(event: React.FormEvent) {
    ...
    const result = await axios.post(
      "http://127.0.0.1:8000/autism_eye_video",
    ...
    navigate("../result_eye_video", { state: { result: result.data } });
  }
  ...
  return (
    ...
    >
      <Typography variant="h4" sx={{}}>
        Please upload your child behaviour video face to camera.(MP4)
      </Typography>
...
export default VideoEYEDetectionPage;
